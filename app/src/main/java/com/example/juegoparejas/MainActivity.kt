...
class MainActivity : AppCompatActivity() {
    ...
    private fun enlazarGUI() {
        ...
        lanzas = R.drawable.lanzas
        charlie = R.drawable.charlie
        carisma = R.drawable.carisma
    ...
    private fun verificar(imagen: View) {
        ...
        if (imagenesArray[tag] == 1_1) {
            iv.setImageResource(verstappen)
        } else if (imagenesArray[tag] == 1_2) {
            iv.setImageResource(norris)
        } else if (imagenesArray[tag] == 1_3) {
            iv.setImageResource(nano)
        } else if (imagenesArray[tag] == 1_4) {
            iv.setImageResource(lanzas)
        } else if (imagenesArray[tag] == 1_5) {
            iv.setImageResource(charlie)
        } else if (imagenesArray[tag] == 1_6) {
            iv.setImageResource(carisma)
